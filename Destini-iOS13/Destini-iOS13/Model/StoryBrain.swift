...
struct StoryBrain {
    ...
    func getStory() -> Story {
        return story[choiceNumber]
    }
    
    mutating func nextStory(_ choice: String) {
        if(choice == story[choiceNumber].choice1) {
            choiceNumber = story[choiceNumber].choice1Destination
        } else {
            choiceNumber = story[choiceNumber].choice2Destination
        }
    }
}
